      ...
      <GuardProvider guards={[loginGuard]}>
       <DashboardLayout>
        <Switch>
         ...
         <GuardedRoute exact path="/products/add" component={AddProduct} />
         <GuardedRoute path="/products/edit/:slug" component={EditProduct} />
         <GuardedRoute exact path="/medias" component={MediaLibrary} />
         <GuardedRoute exact path="/users" component={Users} />
         <GuardedRoute exact path="/users/addusers" component={AddUsers} />
         <GuardedRoute exact path="/roles" component={Roles} />
         <GuardedRoute exact path="/roles/addroles" component={AddRoles} />
         <GuardedRoute exact path="/taxes" component={Taxes} />
         <GuardedRoute exact path="/taxes/add-tax-rule" component={AddTaxRule} />
         <GuardedRoute exact path="/taxes/edit-tax-rule/:slug" component={AddTaxRule} />
         <GuardedRoute exact path="/taxes/add-tax-group" component={AddTaxGroup} />
         <GuardedRoute exact path="/taxes/edit-tax-group/:slug" component={AddTaxGroup} />
         <GuardedRoute exact path="/taxes/add-tax-rate" component={AddTaxRate} />
         <GuardedRoute exact path="/taxes/edit-tax-rate/:slug" component={AddTaxRate} />
         <GuardedRoute exact path="/taxes/add-country" component={AddCountry} />
         <GuardedRoute exact path="/taxes/edit-country/:slug" component={AddCountry} />
